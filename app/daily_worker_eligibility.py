...
def daily_worker_eligibility_app():
    ...
    html += (
        ...
        "  let nextPossible2 = '';"
        "  if (!noWork14Days) { const npDate = new Date(FOURTEEN_DAYS_END); npDate.setDate(npDate.getDate()+14); let nds = npDate.toISOString().split('T')[0]; nextPossible2 = '📅 조건 2를 충족하려면 오늘 이후에 근로제공이 없는 경우 ' + nds + ' 이후에 신청하면 조건 2를 충족할 수 있습니다.'; }"
