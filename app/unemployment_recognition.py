...
st.set_page_config(
    page_title="실업급여 구직활동 FAQ",
    page_icon="🔎",
    layout="wide"
)

# 제목 및 소개
st.title("🔎 실업급여 구직 활동 및 의무 관련 자주 하는 질문 (FAQ)")
...
# 예: "images/job_search_example.png" 또는 "https://example.com/image.jpg"
faqs = [
    {
...
st.markdown("---")
st.markdown("궁금한 점이 해결되셨기를 바랍니다. 더 자세한 정보나 개인별 상황에 대한 상담은 반드시 관할 고용센터에 문의하시기 바랍니다.")
st.markdown("© 2025 실업급여 정보 가이드")
